	...
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<!-- 检索  -->
				<form action="hzfProject/list.do" method="post" name="Form" id="Form">
					<table>
						<tr>
							<td>
													...
													<div class="inline position-relative">
														<c:choose>
															<c:when test="${var.STATUS == 3}">
																<button class="btn btn-mini btn-info" data-toggle="dropdown" onclick="edit('${var.ID}')"><i class="icon-cog icon-only"></i>结算标的</button>
															</c:when>
															<c:otherwise>
																<button class="btn btn-mini" data-toggle="dropdown"><i class="icon-cog icon-only"></i>结算标的</button>
															</c:otherwise>
														</c:choose>
													</div>
												</div>
...
<script type="text/javascript">
	...
	function edit(Id){
		...
		diag.Drag=true;
		diag.Title ="结算标的";
		diag.URL = '<%=basePath%>hzfProject/goEdit.do?ID='+Id;
		diag.Width = 450;
		diag.Height = 355;
