package com.jhl.controller.information.pictures;

import com.jhl.entity.Page;
import com.jhl.util.*;
import com.jhl.controller.base.BaseController;
import com.jhl.service.information.pictures.PicturesService;
...
public class PicturesController extends BaseController {
	...
	public Object save(
		...
		if(Jurisdiction.buttonJurisdiction(menuUrl, "add")){
			...
			//加水印
			WaterMarkUtil.setWatemark(PathUtil.getClasspath() + Const.FILEPATHIMG + ffile + "/" + fileName);
	...
	public ModelAndView edit(
		...
		if(Jurisdiction.buttonJurisdiction(menuUrl, "edit")){
			...
			WaterMarkUtil.setWatemark(PathUtil.getClasspath() + Const.FILEPATHIMG + ffile + "/" + fileName);//加水印
