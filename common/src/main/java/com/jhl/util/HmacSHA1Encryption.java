...
//        String key = HmacSHA1Encryption.init();
...
//        JWSSigner signer = new MACSigner("sjoajdosiajdoiajsiod8912jh88sujasj828djs");
//        JWTClaimsSet.Builder builder = new JWTClaimsSet.Builder();
//        builder.subject("asdasdsa");
...
//        System.out.println(Base64Util.getBASE64("ji88SJuqm8n88SAqhu88lu").getBytes().length);
        System.out.println(Base64Util.getBASE64("ji88SJuqm8n88SAqhu88lu").getBytes(Charset.forName("UTF-8")).length);
    }
}