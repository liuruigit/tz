package com.jhl.controller.system.login;

import com.google.common.base.Strings;
import com.jhl.controller.base.BaseController;
import com.jhl.entity.system.Menu;
import com.jhl.entity.system.Role;
import com.jhl.entity.system.User;
import com.jhl.service.system.menu.MenuService;
import com.jhl.service.system.role.RoleService;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq313596790fh", "").replaceAll("QQ978336446fh", "").split(",jhl,");
