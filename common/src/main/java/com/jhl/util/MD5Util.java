...
/**
 *
 * @date 2011-09-28, 15:12:31
 * @author vic
 * @description MD5Util：md5工具类，常见的md5加密，文件加密
 */
public class MD5Util {
	 ...
	 * @return 检验结果 */
	public static boolean checkPassword(String pwd, String md5) throws Exception{
	 ...
	 * @return 检验结果 */
	public static boolean checkPassword (char[] pwd, String md5) throws Exception{
