...
public class JhAutomatic extends BaseJh{
    ...
    protected JSONObject parseBizResp(JSONObject headJson, String xml) throws Exception {
        ...
        respJson.put("DEAL_TYPE", XmlUtil.getTxtInfo(xml,"DEAL_TYPE"));//处理方式
        respJson.put("VALIDATE_CODE", XmlUtil.getTxtInfo(xml,"VALIDATE_CODE"));//验证码
        respJson.put("INDIVIDUAL_NAME1", XmlUtil.getTxtInfo(xml,"INDIVIDUAL_NAME1"));//自定义输出名称1
        respJson.put("INDIVIDUAL1", XmlUtil.getTxtInfo(xml,"INDIVIDUAL1"));//自定义输出内容1
        respJson.put("INDIVIDUAL_NAME2", XmlUtil.getTxtInfo(xml,"INDIVIDUAL_NAME2"));//自定义输出名称2
        respJson.put("INDIVIDUAL2", XmlUtil.getTxtInfo(xml,"INDIVIDUAL2"));//自定义输出内容2
