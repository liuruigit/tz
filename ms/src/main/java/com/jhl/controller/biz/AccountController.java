...
import com.jhl.service.biz.UserService;
import com.jhl.util.*;
...
public class AccountController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("accountName", "否");	//账号
		pd.put("createTime", "否");	//创建时间
		pd.put("lastLoginTime", "否");	//上次登录时间
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var3", varOList.get(i).getString("accType"));	//3
				vpd.put("var4", varOList.get(i).getString("createTime"));	//4
				vpd.put("var5", varOList.get(i).getString("lastLoginTime"));	//5
				varList.add(vpd);
			}
