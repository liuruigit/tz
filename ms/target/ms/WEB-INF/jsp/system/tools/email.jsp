				...
				<table style="width:100%;" id="xtable">
					<tr>
						<td style="margin-top:0px;">
							 <div style="float: left;width:86%"><textarea name="EMAIL" id="EMAIL" rows="1" cols="50" style="width:100%;height:20px;" placeholder="请选输入对方邮箱,多个请用(;)分号隔开" title="请选输入对方邮箱,多个请用(;)分号隔开"></textarea></div>
							 <div style="float: right;width:10%"><a class='btn btn-mini btn-info' title="编辑邮箱" onclick="dialog_open();"><i class='icon-edit'></i></a></div>
						</td>
					</tr>
					<tr>
						<td>
