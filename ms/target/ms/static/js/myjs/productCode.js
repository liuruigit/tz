 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',jhl,' + dtype + ',jhl,' + dbz + ',jhl,' + isQian + ',jhl,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',jhl,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',jhl,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',jhl,')[0];
			if(array0 == value){
				return false;
			}
		}
