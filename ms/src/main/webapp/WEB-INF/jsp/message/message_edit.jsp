...
<script type="text/javascript">
	...
	//保存
	function save(){
			check_blank("#TITLE",'请输入标题！');
		check_blank("#CONTENT",'请输入消息内容！');
		$("#Form").submit();
		$("#zhongxin").hide();
		$("#zhongxin2").show();
	}
	...
	<form action="message/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><textarea type="text" name="CONTENT" id="CONTENT" rows="8" style="margin: 0px 0px 10px; width: 314px; height: 177px;" maxlength="300" placeholder="消息内容" title="消息内容">${pd.CONTENT}</textarea></td>
			</tr>
