...
public class MockClientMsgBase_Auth {
	
	protected static final Logger log = Logger.getLogger(MockClientMsgBase_Auth.class);
	//测试环境       外部访问地址			http://test1.jytpay.com:8080/JytCPService/tranCenter/encXmlReq.do
	public static String APP_SERVER_URL = "http://test1.jytpay.com:20080/JytAuth/tranCenter/authReq.do";
	...
	public String getMsgRespCode(String respMsg,String headNode) throws Exception{
	...
	public String getMsgState(String respMsg,String bodyNode) throws Exception{
        SAXReader saxReader = new SAXReader();
		Document doc = saxReader.read(new InputSource(new StringReader(respMsg)));
