...
COMMENT ON COLUMN "C##NEWO"."${tabletop}${objectNameUpper}"."ID" IS 'ID';
...
ALTER TABLE "C##NEWO"."${tabletop}${objectNameUpper}" ADD CHECK ("ID" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table "C##NEWO"."${tabletop}${objectNameUpper}"
-- ----------------------------
ALTER TABLE "C##NEWO"."${tabletop}${objectNameUpper}" ADD PRIMARY KEY ("ID");
